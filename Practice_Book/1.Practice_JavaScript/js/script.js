...
let dateEvent = {
    2000: [
        {
            date: '01.01.2001',
            event: 'XXI век',
            descrip: 'Начался XXI век и третье тысячелетие. '
        },
        {
            date: '11.09.2001',
            event: 'Терракт',
        ...
        },
        {
            date: '07.10.2001',
            event: 'Война',
            descrip: 'Начало войны в Афганистане'
        },
        {
            date: '25.10.2001',
            event: 'Windows',
            descrip: 'Выпуск Windows XP'
        }
    ],
    2001: [
        {
    ...
    2002: [
        {
            date: '01.01.2002',
            event: 'Евро',
            descrip: 'Введение банкнот и монет евро в Европейском союзе.'
        },
        {
        ...
        },
        {
            date: '20.05.2002',
            event: 'Независимость',
            descrip: 'Восточный Тимор получил независимость от Индонезии.'
        }
    ],
    2003: [
        {
            date: '01.03.2003',
            event: 'Колумбия',
            descrip: 'Катастрофа шаттла «Колумбия».'
        },
        {
            date: '08.02.2003',
            event: 'Война',
            descrip: 'Начало войны в Ираке.'
        },
        {
            date: '20.05.2003',
            event: 'Независимость',
    ...
    2004: [
        {
            date: '04.02.2004',
            event: 'Facebook',
            descrip: 'Создание Facebook.'
        },
        {
            date: '13 по 29.02.2004',
            event: 'Олимпийские игры',
            descrip: 'XXVIII летние Олимпийские игры в Афинах.'
        },
        {
            date: '22.11.2004 по 08.12.2004',
            event: 'Украина',
            descrip: '«Оранжевая революция» на Украине.'
        },
        {
            date: '26.12.2004',
            event: 'Землетрясение',
    ...
    2005: [
        ...
        },
        {
            date: '14.02.2005',
            event: 'YouTube',
            descrip: 'создание YouTube.'
        },
    ],
    2006: [
        {
            date: '10 по 26.02.2006',
            event: 'Олимпийские игры',
            descrip: 'XX зимние Олимпийские игры в Турине (Италия).'
        },
        {
            date: '03.06.2006',
            event: 'Черногория',
        ...
        },
        {
            date: '24.08.2006',
            event: 'Планеты',
            descrip: 'Плутон лишён статуса планеты.'
        },
    ],
    2007: [
        {
            date: '09.01.2007',
            event: 'Apple',
            descrip: 'компания Apple представила iPhone первого поколения.'
        },
        {
            date: '20.01.2007',
            event: 'Windows',
            descrip: 'Выпуск Windows Vista.'
        },
    ],
}
...
let test = {
    '01.21': {
        'Водолей': {
            today: 'Этот день не обойдется без сюрпризов. Скорее всего, ' +
                'планы придется менять часто: многое будет идти совсем не так,' +
                ' как вы ожидали. Важную роль сыграет неожиданная встреча или знакомство' +
                ' с человеком, о котором вы раньше много слышали. Не исключено ' +
                'и получение чрезвычайно важной информации. Она поможет принять ' +
                'верное решение, подскажет, как лучше действовать.\n' +
                '\n' +
                'Вероятны спонтанные покупки. Незапланированные расходы чаще' +
                ' всего будут вызваны вашим желанием порадовать близких. Жалеть' +
                ' о таких тратах не придется.',
